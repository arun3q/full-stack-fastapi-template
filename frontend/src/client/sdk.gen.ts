...
export class OrganizationsService {
     ...
     * @throws ApiError
     */
    public static unsuspendOrganization(data: OrganizationsUnsuspendOrganizationData): CancelablePromise<OrganizationsUnsuspendOrganizationResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/organizations/{organization_id}/unsuspend',
            path: {
                organization_id: data.organizationId
            },
            errors: {
